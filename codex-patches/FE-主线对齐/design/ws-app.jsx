...
function App() {
  ...
  const run = (cmd) => {
    switch (cmd.type) {
      ...
      case "tweaks": window.postMessage({ type: "__activate_edit_mode" }, "*"); break;
      case "scene":
        go("writer");
  ...
  return (
    <aside className="ws-rail">
      ...
      <div className="ws-rail-foot">
        ...
        <button className="ws-foot-btn" onClick={() => window.postMessage({ type: "__activate_edit_mode" }, "*")} title="舒适度设置">
