...
async function reloadAll() {
  await Promise.all([workbench.refreshAll(), reviewInbox.load(), indexConsole.load()]);
  ...
  if (!workbench.error && !reviewInbox.error && !indexConsole.error) {
...
<template>
  <div class="shell">
    <!-- Scene Workbench / Review Inbox / Index Console -->
    <aside class="rail">
      <div class="brand">
