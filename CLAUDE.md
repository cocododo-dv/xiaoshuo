...
- **Demo vs. real data**: the 「潮汐档案」 demo work is the only place demo/decorative data appears (its control tower is demo-gated); offline demo output must be user-chosen and labeled as demo provenance — real works and real provider runs never mix with it.
