...
SECTION_SPECS: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ...
    ("tension_pacing", "Tension & Pacing Constraint", ("tension_pacing",)),
    ("theme_expression_budget", "Theme Anchor & Expression Budget", ("theme_expression_budget",)),
    ...
    ("foreshadow_directives", "Foreshadow Lifecycle Directives", ("foreshadow_directives",)),
    ("chapter_transition_buffer", "Chapter Transition Buffer", ("chapter_transition_buffer",)),
    ("pov_voice_coloring", "POV Voice Coloring", ("pov_voice_coloring",)),
    ("character_psychology", "Character Psychology Model", ("character_psychology",)),
    ("voice_fingerprint", "Voice Fingerprint", ("voice_fingerprint",)),
    ("relationship_matrix", "Relationship Dynamics Matrix", ("relationship_matrix",)),
    ("character_arc_weights", "Character Decision Weights (arc progression)", ("character_arc_weights",)),
    ...
    ("narrative_patterns", "Narrative Patterns", ("narrative_pattern",)),
