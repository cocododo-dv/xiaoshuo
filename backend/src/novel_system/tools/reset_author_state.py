...
def _reset_targets() -> list[ResetTarget]:
    targets = [
        ...
        ResetTarget("reindex_jobs", ReindexJob),
        ResetTarget("verify_jobs", VerifyJob),
        ResetTarget("vector_alias_registry", VectorAliasRegistry),
        ResetTarget("version_registry", VersionRegistry),
        ResetTarget("project_backtrack_items", ProjectBacktrackItem),
        ...
        ResetTarget("author_structure_candidates", AuthorStructureCandidate),
        ...
        ResetTarget("scene_quality_contracts", SceneQualityContract),
        ...
        ResetTarget("longform_diagnostic_cards", LongformDiagnosticCard),
        ResetTarget("longform_structure_guidance", LongformStructureGuidance),
        ResetTarget("author_preference_profiles", AuthorPreferenceProfile),
        ResetTarget("work_profiles", WorkProfile),
        ResetTarget("style_observations", StyleObservation),
        ResetTarget("style_rules", StyleRule),
        ResetTarget("narrative_patterns", NarrativePattern),
        ResetTarget("banned_rule_clusters", BannedRuleCluster),
        ResetTarget("world_rules", WorldRule),
        ResetTarget("calibration_lines", CalibrationLine),
        ResetTarget("foreshadow_tracker", ForeshadowTracker),
