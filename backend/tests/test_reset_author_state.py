...
def _seed_author_state(session) -> None:
    ...
    session.add_all(
        [
            ...
            StagedBackfill(
                stage_id="stage_reset_scene",
                chapter_id="CH_RESET_SNOW",
                scene_id="SC_RESET_SNOW_01",
                marker_id="marker-1",
                marker_text="insert clue",
                marker_token="TOKEN_RESET",
                status="pending",
            ),
            SceneBundle(
            ...
            SceneQualityContract(
                contract_id="scene_quality_reset",
                scene_id="SC_RESET_SNOW_01",
                chapter_id="CH_RESET_SNOW",
                contract_version="scene_quality_contract_v1",
                contract_hash="quality-hash",
                source_snapshot_hash="snapshot-hash",
                payload_json={"quality": "tight"},
                status="active",
            ),
            SceneExecutionContract(
            ...
            AutoRewriteRun(
                ...
                source_final_scene_row_id="final_scene_reset",
                candidate_draft_row_id="scene_draft_reset",
                promoted_final_scene_row_id=None,
                rollback_target_final_scene_row_id=None,
                llm_call_id="llm_call_author_scene",
                gate_results_json={"gate": "fail"},
                policy_json={"policy": "strict"},
                promotion_blockers_json=["stakes"],
            ...
            AuthorStructureCandidate(
                candidate_id="structure_candidate_reset",
                object_type="scene",
                object_id="SC_RESET_SNOW_01",
                chapter_id="CH_RESET_SNOW",
                scene_id="SC_RESET_SNOW_01",
                source_draft_id="author_draft_reset",
                source_text_ref="author_draft:author_draft_reset",
                extraction_llm_call_id="llm_call_author_scene",
                candidate_brief_json={"beats": ["arrive", "discover"]},
                uncertainty_notes_json=["timeline unclear"],
                rationale="extract structure for review",
                status="candidate",
                author_decision="pending",
            ),
            AuthorPreferenceProfile(
            ...
            WorkProfile(
                profile_id="work_profile_reset",
                scope_type="chapter",
                scope_ref_id="CH_RESET_SNOW",
                profile_key="strong_plot",
                display_name="Strong Plot",
                description="keep the chapter moving",
                profile_json={"cadence": "fast"},
                status="active",
            ),
            LongformDiagnosticCard(
                card_id="longform_card_reset",
                ...
                scene_id="SC_RESET_SNOW_01",
                character_id="CHAR_RESET",
                source_refs_json=["author_draft:author_draft_reset"],
                evidence_json={"issue": "cost is vague"},
                recommendation_json={"summary": "show the sacrifice"},
                source_snapshot_hash="snapshot-longform",
                review_id="review_author_scene",
            ),
            LongformStructureGuidance(
                guidance_id="guidance_reset",
                card_id="longform_card_reset",
                scope_type="scene",
                scope_ref_id="SC_RESET_SNOW_01",
                content="keep the conflict escalating",
                status="approved",
                runtime_eligible=1,
                source_review_id="review_author_scene",
                evidence_json={"scene": "SC_RESET_SNOW_01"},
                recommendation_json={"keep": "pressure visible"},
            ),
            SceneMemory(
            ...
            ProjectBacktrackItem(
                item_id="backtrack_reset",
                project_id="PRJ_RESET_SNOW",
                chapter_id="CH_RESET_SNOW",
                scene_id="SC_RESET_SNOW_01",
                scope="scene",
                target_ref="SC_RESET_SNOW_01",
                status="pending",
                problem_summary="execution contract is stale",
                recommended_fix="regenerate scene plan",
                reason_codes_json=["contract_stale"],
                source_qc_report_id="qc_report_reset",
                source_contract_id="scene_execution_reset",
            ),
            VoiceProfile(
            ...
            StyleObservation(
                row_id="style_observation_reset",
                style_observation_id="STYLE_RESET",
                version=1,
                scope="scene",
                scope_ref_id="SC_RESET_SNOW_01",
                text="end with a deferred revelation",
                source_review_id="review_author_scene",
                active_flag=1,
                runtime_eligible=1,
            ...
            StyleRule(
                row_id="style_rule_reset",
                style_rule_set_id="STYLE_RULE_RESET",
                version=1,
                scope="global",
                scope_ref_id="global",
                content="keep paragraphs lean",
                active_flag=1,
                runtime_eligible=1,
                runtime_eligibility_basis="direct_read",
            ),
            NarrativePattern(
                row_id="narrative_pattern_reset",
                narrative_pattern_id="PATTERN_RESET",
                version=1,
                scope="global",
                scope_ref_id="global",
                content="tighten aftermath beats",
                active_flag=1,
                runtime_eligible=1,
                runtime_eligibility_basis="direct_read",
            ),
            BannedRuleCluster(
                row_id="banned_cluster_reset",
                banned_cluster_id="BAN_RESET",
                version=1,
                scope="global",
                scope_ref_id="global",
                content="avoid announcing twists before they land",
                active_flag=1,
                runtime_eligible=1,
                runtime_eligibility_basis="direct_read",
            ),
            WorldRule(
                row_id="world_rule_reset",
                world_rule_id="WORLD_RESET",
                version=1,
                scope="global",
                scope_ref_id="global",
                rule_tier="hard",
                content="city archives close at midnight",
                active_flag=1,
                runtime_eligible=1,
                runtime_eligibility_basis="direct_read",
            ),
            CalibrationLine(
                row_id="calibration_line_reset",
                calibration_line_id="CAL_RESET",
                version=1,
                scope="global",
                scope_ref_id="global",
                text="the lock clicked like a threat kept too long",
                active_flag=1,
                runtime_eligible=1,
                runtime_eligibility_basis="vector_ready",
            ),
            ForeshadowTracker(
                row_id="foreshadow_reset",
                foreshadow_id="FORESHADOW_RESET",
                version=1,
                chapter_id="CH_RESET_SNOW",
                scene_id="SC_RESET_SNOW_01",
                text="the missing ledger appears in the opening scene",
                tracker_status="open",
                source_review_id="review_author_scene",
                active_flag=1,
                runtime_eligible=1,
            ...
            VersionRegistry(
                ...
                lineage_key="STYLE_RESET",
                version=1,
                physical_row_id="style_observation_reset",
                alias_scope="style_observation:scene:SC_RESET_SNOW_01",
            ...
            VectorAliasRegistry(
                ...
                scope="scene",
                scope_ref_id="SC_RESET_SNOW_01",
                collection_family="style_observation_scene_reset",
                active_alias="style_observation_scene_reset__active",
                candidate_alias=None,
                active_snapshot_version="snapshot__style_observation_reset",
                candidate_snapshot_version=None,
                active_embedding_version="embed__style_observation_reset",
                candidate_embedding_version=None,
                verify_status="succeeded",
                sample_query_success=1,
            ),
            ReindexJob(
                job_id="reindex_reset",
                review_id="review_author_scene",
                status="completed",
                object_type="style_observation",
                alias_scope="style_observation:scene:SC_RESET_SNOW_01",
                target_snapshot_version="snapshot__style_observation_reset",
                target_embedding_version="embed__style_observation_reset",
                worker_id="worker-reindex",
                attempt_no=1,
            ),
            VerifyJob(
                job_id="verify_reset",
            ...
            InteropArtifact(
                artifact_id="interop_reset",
                artifact_kind="scene_export",
                scene_id="SC_RESET_SNOW_01",
                chapter_id="CH_RESET_SNOW",
                source_bundle_id="bundle_reset_scene",
                file_path="exports/reset-scene.txt",
                file_format="txt",
                file_checksum="checksum-interop",
                direction="export",
                status="completed",
                metadata_json={"scene_id": "SC_RESET_SNOW_01"},
            ),
            IdempotencyKey(
            ...
            ReconcileFault(
                ...
                severity="warning",
                object_ref="style_observation:scene:SC_RESET_SNOW_01",
                details_json={"status": "stale"},
            ),
        ]
    )
